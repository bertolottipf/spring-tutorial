...
.Article.java
----
include::{sourcedir}/tutorial/spring/model/Article.java[lines=16..33]
----
...
.Articles.java
----
include::{sourcedir}/tutorial/spring/controller/Articles.java[lines=17..28]
----
...
.index.ftl
----
include::{sourcedir}/../resources/templates/index.ftl[]
----
